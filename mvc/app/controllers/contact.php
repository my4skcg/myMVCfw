...
class contact extends \Lib\controller {
  ...
  public function __construct() {
	...
	// this should be a private function, but for phpunit testing, it is public
	...
	// this should be a private function, but for phpunit testing, it is public
	//   what can I do about this?
	public function validateFields($c) {
	...
	public function buildViewParams() {
		...
		$contacts = $this->contactdoa->getData($uid);
